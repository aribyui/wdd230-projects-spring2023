if (typeof(Storage) !== "undefined") {
  ...
  if (lastVisit) {
      ...
      document.getElementById("time-between").textContent = `Days since your last visit: ${daysSinceVisit}`;
  } else {
      document.getElementById("time-between").textContent = "Welcome! This is your first visit";
  }
